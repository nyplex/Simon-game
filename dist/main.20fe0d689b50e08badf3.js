...
/* harmony export */ });
/* harmony import */ var _gamePlay__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gamePlay */ "./src/assets/js/gamePlay.js");
/* harmony import */ var _utilities__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utilities */ "./src/assets/js/utilities.js");
...
class Game {
     ...
     */
    userSays() {
        $("#simon-text").html((0,_utilities__WEBPACK_IMPORTED_MODULE_1__.usersTurn)(this))
        $("*[data-lens]").off()
        $(window).off()
        ...
        (0,_gamePlay__WEBPACK_IMPORTED_MODULE_0__.colorsInteraction)(this)
    ...
    async userAddToSequence() {
        if((0,_gamePlay__WEBPACK_IMPORTED_MODULE_0__.timeToRotate)(this.sequence.length, this)) {
            await (0,_utilities__WEBPACK_IMPORTED_MODULE_1__.delay)(2100)
        }
        (0,_gamePlay__WEBPACK_IMPORTED_MODULE_0__.colorsInteraction)(this)
        $("*[data-lens]").on("click", (e) => {
            ...
            this.userSequence = []
            ;(0,_gamePlay__WEBPACK_IMPORTED_MODULE_0__.rotateColors)(this.sequence.length, this)
            this.userSays()
        })
    }
        ...
        if(this.userSequence[length] === this.sequence[length]) {
            if(this.userSequence.length === this.sequence.length) {
                ...
                if(this.mode === 1) {
                    ...
                    this.userSequence = []
                    await (0,_utilities__WEBPACK_IMPORTED_MODULE_1__.delay)(500)
                    this.simonSay()
                    return
                }else {
    ...
    async wrongSequence(user, simon) {
        // play buzz sound
        let music = (0,_utilities__WEBPACK_IMPORTED_MODULE_1__.getSound)("buzz", this)
        if(music) {
            music.play()
        }
        ...
        if(this.players.length > 1) {
            ...
            await (0,_utilities__WEBPACK_IMPORTED_MODULE_1__.delay)(1500)
        ...
        (0,_gamePlay__WEBPACK_IMPORTED_MODULE_0__.gameOver)(this, user, simon)
    }
    ...
    async #playSequence(sequence) {
        ...
        await (0,_utilities__WEBPACK_IMPORTED_MODULE_1__.delay)(1000)
        ;(0,_utilities__WEBPACK_IMPORTED_MODULE_1__.IncreaseSpeed)(sequence.length, this)
        for(let i = 0; i < sequence.length; i ++) {
            let target = $(`*[data-lens="${sequence[i]}"]`)
            let music = (0,_utilities__WEBPACK_IMPORTED_MODULE_1__.getSound)(sequence[i], this)
            if(music != false) {
                music.currentTime = 0;
                music.play()
            }
            (0,_gamePlay__WEBPACK_IMPORTED_MODULE_0__.lightsOn)(target[0], sequence[i])
            await (0,_utilities__WEBPACK_IMPORTED_MODULE_1__.delay)(this.speed)
            ;(0,_gamePlay__WEBPACK_IMPORTED_MODULE_0__.lightsOff)(target[0], sequence[i])
            await (0,_utilities__WEBPACK_IMPORTED_MODULE_1__.delay)(this.speed)
        }
        (0,_gamePlay__WEBPACK_IMPORTED_MODULE_0__.rotateColors)(sequence.length, this)
        if((0,_gamePlay__WEBPACK_IMPORTED_MODULE_0__.timeToRotate)(sequence.length, this)) {
            await (0,_utilities__WEBPACK_IMPORTED_MODULE_1__.delay)(2100)
        }
        this.userSays()
    }
...
/* harmony export */   "displayMobileMenu": () => (/* binding */ displayMobileMenu),
/* harmony export */   "setupNewGame": () => (/* binding */ setupNewGame),
/* harmony export */   "getUsersName": () => (/* binding */ getUsersName)
/* harmony export */ });
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! . */ "./src/assets/js/index.js");
/* harmony import */ var _gamePlay__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./gamePlay */ "./src/assets/js/gamePlay.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
let setupInteraction = (game) => {
        ...
        switch(dataKeys) {
            case "theme":
                ...
                if($(e.target).data("theme") === 2) {
                    game.sounds = {
                        blue: (0,___WEBPACK_IMPORTED_MODULE_0__.loadSoundFiles)("blue", "fx2"),
                        red: (0,___WEBPACK_IMPORTED_MODULE_0__.loadSoundFiles)("red", "fx2"),
                        green: (0,___WEBPACK_IMPORTED_MODULE_0__.loadSoundFiles)("green", "fx2"),
                        yellow: (0,___WEBPACK_IMPORTED_MODULE_0__.loadSoundFiles)("yellow", "fx2"),
                        pink: (0,___WEBPACK_IMPORTED_MODULE_0__.loadSoundFiles)("pink", "fx2"),
                        buzz: (0,___WEBPACK_IMPORTED_MODULE_0__.loadSoundFiles)("buzz", "fx2"),
                    }
                }else if($(e.target).data("theme") === 3) {
                    game.sounds = {
                        blue: (0,___WEBPACK_IMPORTED_MODULE_0__.loadSoundFiles)("blue", "fx3"),
                        red: (0,___WEBPACK_IMPORTED_MODULE_0__.loadSoundFiles)("red", "fx3"),
                        green: (0,___WEBPACK_IMPORTED_MODULE_0__.loadSoundFiles)("green", "fx3"),
                        yellow: (0,___WEBPACK_IMPORTED_MODULE_0__.loadSoundFiles)("yellow", "fx3"),
                        pink: (0,___WEBPACK_IMPORTED_MODULE_0__.loadSoundFiles)("pink", "fx3"),
                        buzz: (0,___WEBPACK_IMPORTED_MODULE_0__.loadSoundFiles)("buzz", "fx3"),
                    }
                }
                break;
            case "players":
    ...
    $("#playButton").on("click", () => {
        ...
        if(game.playersNumber > 1) {
            ...
            displayMobileMenu()
            ;(0,_gamePlay__WEBPACK_IMPORTED_MODULE_1__.generateGamePlay)(game)
        }
    })
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "generateGamePlay": () => (/* binding */ generateGamePlay),
/* harmony export */   "colorsInteraction": () => (/* binding */ colorsInteraction),
/* harmony export */   "lightsOn": () => (/* binding */ lightsOn),
/* harmony export */   "lightsOff": () => (/* binding */ lightsOff),
/* harmony export */   "rotateColors": () => (/* binding */ rotateColors),
/* harmony export */   "timeToRotate": () => (/* binding */ timeToRotate),
/* harmony export */   "gameOver": () => (/* binding */ gameOver)
/* harmony export */ });
/* harmony import */ var _display__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./display */ "./src/assets/js/display.js");
/* harmony import */ var _utilities__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utilities */ "./src/assets/js/utilities.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
 ...
 * @param {Object} game 
 */
let generateGamePlay = (game) => {
    (0,_utilities__WEBPACK_IMPORTED_MODULE_1__.getColors)(game)
    ...
    ;(0,_utilities__WEBPACK_IMPORTED_MODULE_1__.countDown)(5, game)
}
 ...
 * @param {Object} game 
 */
let colorsInteraction = (game) => {
    $(".circle").addClass("cursor-pointer")
    $("*[data-lens]").on("mousedown, pointerdown", (e) => {
        const data = $(e.target).data("lens")
        let music = (0,_utilities__WEBPACK_IMPORTED_MODULE_1__.getSound)(data, game)
 ...
 * @param {Object} game 
 */
let rotateColors = (sequence, game) => {
 ...
 * @returns {boolean}
 */
let timeToRotate = (sequence, game) => {
 ...
 * @returns 
 */
let gameOver = (game, user, simon) => {
    $("#header-logo").text("")
    $("#desktop-nav").hide()
    $("#burger-icon").hide()
    ;(0,_display__WEBPACK_IMPORTED_MODULE_0__.setupNewGame)()
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "loadSoundFiles": () => (/* binding */ loadSoundFiles)
/* harmony export */ });
/* harmony import */ var _css_main_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../css/main.css */ "./src/assets/css/main.css");
/* harmony import */ var _display__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./display */ "./src/assets/js/display.js");
/* harmony import */ var _gamePlay__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./gamePlay */ "./src/assets/js/gamePlay.js");
/* harmony import */ var _Game__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Game */ "./src/assets/js/Game.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
 ...
 */
let loadSoundFiles = (fileName, folder) => {
...
if(sessionStorage.getItem("game")) {
    ...
    let game = new _Game__WEBPACK_IMPORTED_MODULE_3__.Game(value.theme, value.usernames, value.mode, value.level, soundObject, value.usernames, value.playersNumber)
    ...
    $("#main-header").removeClass("hidden")
    //display the mobile's nav
    ;(0,_display__WEBPACK_IMPORTED_MODULE_1__.displayMobileMenu)()
    ;(0,_gamePlay__WEBPACK_IMPORTED_MODULE_2__.generateGamePlay)(game)
    listenForRestart(game)
    
}else{
    const game = new _Game__WEBPACK_IMPORTED_MODULE_3__.Game(1, [1], 1, 1, soundObject, [], 1)
    ;(0,_display__WEBPACK_IMPORTED_MODULE_1__.displayMenu)(game)
    listenForRestart(game)
}
...
/* harmony export */   "IncreaseSpeed": () => (/* binding */ IncreaseSpeed),
/* harmony export */   "getColors": () => (/* binding */ getColors),
/* harmony export */   "countDown": () => (/* binding */ countDown),
/* harmony export */   "usersTurn": () => (/* binding */ usersTurn)
/* harmony export */ });
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/**
 * delay
 ...
 * @returns {boolean} 
 */
let IncreaseSpeed = (sequence, game) => {
    let result = (sequence - 1) / 4
