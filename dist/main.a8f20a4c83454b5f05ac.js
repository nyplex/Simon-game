...
class Game {
    ...
    async wrongSequenceMode3(playerIndex, color) {
        if(this.players.length <= 2) {
            (0,_gamePlay__WEBPACK_IMPORTED_MODULE_0__.gameOver)(this)
        }
...
let setupInteraction = (game) => {
    ...
    $("#playButton").on("click", () => {
        ...
        displayMobileMenu()
        ;(0,_gamePlay__WEBPACK_IMPORTED_MODULE_0__.generateGamePlay)(game)
    })
}
...
/* harmony import */ var _Game__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Game */ "./src/assets/js/Game.js");
...
const game = new _Game__WEBPACK_IMPORTED_MODULE_2__.Game(1, [1], 1, 1, {
    blue: blueSound,
    red: redSound,
    green: greenSound,
    yellow: yellowSound,
