...
class Game {
    ...
    #lightsOn() {
        ...
        $("*[data-lens]").on("mousedown, pointerdown", (e) => {
            ...
            let music = (0,_utilities__WEBPACK_IMPORTED_MODULE_0__.getSound)(data, this)
            switch (data) {
                case "red": 
    ...
    async #playSequence(sequence) {
        ...
        await (0,_utilities__WEBPACK_IMPORTED_MODULE_0__.delay)(1000)
        if((0,_utilities__WEBPACK_IMPORTED_MODULE_0__.IncreaseSpeed)(sequence.length)) {
            if(this.speed <= 300) {
                this.speed -= 100
            }
        }
        for(let i = 0; i < sequence.length; i ++) {
            ...
            let music = (0,_utilities__WEBPACK_IMPORTED_MODULE_0__.getSound)(sequence[i], this)
            if(music != false) {
                music.play()
            }
            ...
            await (0,_utilities__WEBPACK_IMPORTED_MODULE_0__.delay)(this.speed)
